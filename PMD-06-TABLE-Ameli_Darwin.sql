-- Generated from Visual Paradigm in MOD-clef/MPD/MODclef.ddl
...
INSERT INTO Personnes (id, nom, prenom, email) VALUES (Personne_SEQPK.NEXTVAL, 'Durand', 'Sophie', 'sophie.durand@he-arc.ch');
INSERT INTO Personnes (id, nom, prenom, email) VALUES (Personne_SEQPK.NEXTVAL, 'Petit', 'Jean', 'jean.petit@he-arc.ch');

-- Insertions pour la table Groupes
INSERT INTO Groupes (id, nom, description) VALUES (Groupe_SEQPK.NEXTVAL, 'HE-Arc Informatique', 'Département Informatique de la HE-Arc');
INSERT INTO Groupes (id, nom, description) VALUES (Groupe_SEQPK.NEXTVAL, 'HE-Arc Ingénierie', 'Département Ingénierie de la HE-Arc');
...
INSERT INTO Acces (iddep, Groupe_id, Lieu_id, date_debut, date_fin) VALUES (Acces_SEQPK.NEXTVAL, (SELECT id FROM Groupes WHERE nom = 'HE-Arc Informatique'), (SELECT id FROM Lieux WHERE nom = 'Campus Arc 1'), TO_TIMESTAMP('2024-03-01 08:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-03-01 18:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO Acces (iddep, Groupe_id, Lieu_id, date_debut, date_fin) VALUES (Acces_SEQPK.NEXTVAL, (SELECT id FROM Groupes WHERE nom = 'HE-Arc Ingénierie'), (SELECT id FROM Lieux WHERE nom = 'Campus Arc 2'), TO_TIMESTAMP('2024-03-02 08:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-03-02 18:00:00', 'YYYY-MM-DD HH24:MI:SS'));
...
INSERT INTO FAIS_PARTIE_DE (personne_id, groupe_id) VALUES ((SELECT Personnes WHERE nom = 'Durand' AND prenom = 'Sophie'),(SELECT Groupes WHERE nom = 'HE-Arc Informatique'));
INSERT INTO FAIS_PARTIE_DE (personne_id, groupe_id) VALUES ((SELECT Personnes WHERE nom = 'Durand' AND prenom = 'Sophie'),(SELECT Groupes WHERE nom = 'HE-Arc Ingénierie'));
INSERT INTO FAIS_PARTIE_DE (personne_id, groupe_id) VALUES ((SELECT Personnes WHERE nom = 'Petit' AND prenom = 'Jean'),(SELECT Groupes WHERE nom = 'HE-Arc Informatique'));
INSERT INTO FAIS_PARTIE_DE (personne_id, groupe_id) VALUES ((SELECT Personnes WHERE nom = 'Petit' AND prenom = 'Jean'),(SELECT Groupes WHERE nom = 'HE-Arc Ingénierie'));
